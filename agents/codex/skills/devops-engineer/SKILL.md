...
description: Use this skill when working on infrastructure, CI/CD pipelines, Docker configurations, deployment scripts, environment setup, or any DevOps-related tasks. This includes creating or modifying Dockerfiles, docker-compose files, GitHub Actions, GitLab CI, Makefiles, shell scripts for automation, or when optimizing build processes and resource usage.
---
